    ...
    fluidPage(
      fluidRow(
        selectizeInput(
          inputId = ns("area_sel"),
          label = "Select Area",
          # TODO - Check - I will join by WRIA_NR to dfCulverts but should we use WRIA_ID instead (WRIA_ID is not in dfCulverts)?
          choices = setNames(
      ...
      fluidRow(
        selectizeInput(
          ...
          choices = setNames(
            dfCulverts %>% dplyr::distinct(owner_type_code) %>% dplyr::pull(owner_type_code) %>% sort(),
      ...
      conditionalPanel(
        ...
        fluidRow(
          column(6,
            ...
            # TODO - Check - scatter plot variable choices from dfCulverts.
            choices = setNames(
      ...
      conditionalPanel("input.plot_type == 'Histogram'",
        ...
        selectInput(
          ...
          # TODO - Check - scatter plot variable choices from dfCulverts (removed potential_species).
          choices = setNames(
